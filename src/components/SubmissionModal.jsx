...
const SCORING_CRITERIA = [
    {
        ...
        description: 'Uniqueness of the solution and creative approach to solving the problem',
        maxScore: 10
    },
    {
        id: 'score2',
        name: 'Technical Complexity',
        description: 'Sophistication of the technical implementation and use of advanced features',
        maxScore: 10
    },
    {
        id: 'score3',
        name: 'Social Impact',
        description: 'Potential impact on society and addressing real-world problems',
        maxScore: 10
    },
    {
        id: 'score4',
        name: 'User Experience & Design',
        description: 'Quality of user interface, user experience, and overall design',
        maxScore: 10
    },
    {
        id: 'score5',
...
export function SubmissionModal({ submission, onClose }) {
                    ...
                    <div className="p-6 max-w-4xl mx-auto">
                        ...
                        <div className="prose max-w-none">
                            ...
                            <div className="pt-6 mt-6">
                                <h3 className="text-xl font-semibold mb-6 text-white">Jury Evaluation</h3>
                                <div className="space-y-6">
                                    {SCORING_CRITERIA.map((criteria) => (
                                        <div key={criteria.id} className="bg-gray-50 p-4 rounded-lg">
                                            <div className="flex justify-between items-center mb-2">
                                                <label htmlFor={criteria.id} className="font-medium text-gray-900">
                                                    {criteria.name}
                                                </label>
