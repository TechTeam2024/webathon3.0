...
function Home() {
  ...
  <CircularText text="ACM . VNRVJIET . WEBATHON . " spinDuration={10} imageSrc="/ACMlogo.png" />
      ...
      <div className="relative z-0 w-full min-h-screen flex flex-col items-center justify-center text-center p-5 sm:mt-20 md:mt-32 lg:mt-10">
        ...
        <HeaderAnimation
          text="WEBATHON 3.0"
          className="webathon-heading text-[clamp(2.5rem, 8vw, 6rem)] text-5xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl w-full bg-black sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-webathon font-bold"
          delay={100}
