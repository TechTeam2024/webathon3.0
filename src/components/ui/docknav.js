  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        animate={{ opacity: 1, y: 10 }} // Moves text DOWN
        exit={{ opacity: 0, y: 0 }}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} absolute top-5 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4`}
